...
export class CartItemComponent {
  ...
  constructor(private router:ActivatedRoute,private cservice:CartService, private mservice:MedicineService, private uservice:UserService, private rout:Router) { }
